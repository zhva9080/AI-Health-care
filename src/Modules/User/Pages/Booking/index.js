                        ...
                        <div>
                            ...
                            <div className="row">
                                {doctor.map((e)=>
                                    ...
                                    <button className="col-5 form-control btn btn-success my-4 mx-3" value={e.clinic_timing} onClick={(e) => dispatch(setBooking({ ...BookingState, booking_time: e.target.value }))}>{e.clinic_timing}</button>
                                )
                                }
                                {/* 
